...
@property(retain, nonatomic) NSString *experimentalStyle; // @dynamic experimentalStyle;
...
@property(nonatomic) _Bool hasExperimentalStyle; // @dynamic hasExperimentalStyle;
