...
@class NSMutableArray, NSString, UIButton, UIImageView, UILabel, UITableView, UITableViewCell, UIView, UPOMP_CVN2CellViewController, UPOMP_KaNet, UPOMP_PanDateCellViewController, UPOMP_PinCellViewController;

@interface UPOMP_QuickCardViewController : UPOMP_ViewController <UITableViewDataSource, UITableViewDelegate, UPOMP_KaNetDelegate>
{
