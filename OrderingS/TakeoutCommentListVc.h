...
@class NSString, TakeoutCommentListDTO;

@interface TakeoutCommentListVc : BaseSingleListVc
{
    int _fromTag;
    TakeoutCommentListDTO *_dto;
    NSString *_uuid;
}

@property(retain, nonatomic) NSString *uuid; // @synthesize uuid=_uuid;
@property(nonatomic) int fromTag; // @synthesize fromTag=_fromTag;
@property(retain, nonatomic) TakeoutCommentListDTO *dto; // @synthesize dto=_dto;
