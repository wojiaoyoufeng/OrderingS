...
@class CSZyInput, NSString, NSTimer, UIButton, UIView;

@interface XsLoginOrRegByPhoneVc : BaseFormVc <UITextFieldDelegate, UIScrollViewDelegate>
{
    int _countNum;
    int _requestTag;
    int _typeTagForTelAuth;
    CSZyInput *_ctrlPhoneNum;
    UIButton *_ctrlRequestPasscode;
    UIView *_ctrlPasscodeValidatePanel;
    CSZyInput *_ctrlPasscode;
...
@property(retain, nonatomic) CSZyInput *ctrlPasscode; // @synthesize ctrlPasscode=_ctrlPasscode;
@property(retain, nonatomic) UIView *ctrlPasscodeValidatePanel; // @synthesize ctrlPasscodeValidatePanel=_ctrlPasscodeValidatePanel;
@property(retain, nonatomic) UIButton *ctrlRequestPasscode; // @synthesize ctrlRequestPasscode=_ctrlRequestPasscode;
@property(retain, nonatomic) CSZyInput *ctrlPhoneNum; // @synthesize ctrlPhoneNum=_ctrlPhoneNum;
