...
@class NSString, TakeoutMenuList2DTO;

@interface TakeoutGiftMenuListVc : BaseSingleListVc
{
    TakeoutMenuList2DTO *_dto;
    NSString *_takeoutId;
    NSString *_typeId;
}
...
@property(retain, nonatomic) TakeoutMenuList2DTO *dto; // @synthesize dto=_dto;
