...
@interface MTAWXO : NSObject
{
    struct dispatch_queue_s *task_queue;
    NSString *_MTAWXOCurrentPage;
    NSString *_lastPage;
}
...
@property(retain, nonatomic) NSString *MTAWXOCurrentPage; // @synthesize MTAWXOCurrentPage=_MTAWXOCurrentPage;
- (id)autorelease;
