...
@class AddressAnnotation, MKMapView, NSObject<RDInfoPanelViewDelegate>, NSString;

@interface RDInfoPanelView : RestDetailPanelView <MKMapViewDelegate>
{
    NSObject<RDInfoPanelViewDelegate> *_delegate;
    MKMapView *_ctrlMap;
...
@property NSObject<RDInfoPanelViewDelegate> *delegate; // @synthesize delegate=_delegate;
- (int)calMapHeight;
- (float)addressHeight;
- (float)cellHeight;
