...
@class BaseBizVc, CSPageControl, NSMutableArray, NSObject<CSZyMainAdvImgPanelDelegate>, NSString, NSTimer, UIScrollView;

@interface CSZyMainAdvImgPanel : UIView <UIScrollViewDelegate>
{
    NSObject<CSZyMainAdvImgPanelDelegate> *_delegate;
    BaseBizVc *_nrVc;
...
@property NSObject<CSZyMainAdvImgPanelDelegate> *delegate; // @synthesize delegate=_delegate;
- (_Bool)chkIsClosed;
